...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../node_modules/css-loader/dist/runtime/noSourceMaps.js */ \"./node_modules/css-loader/dist/runtime/noSourceMaps.js\");\n/* harmony import */ var _node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../node_modules/css-loader/dist/runtime/api.js */ \"./node_modules/css-loader/dist/runtime/api.js\");\n/* harmony import */ var _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1__);\n// Imports\n\n\nvar ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));\n// Module\n___CSS_LOADER_EXPORT___.push([module.id, `#projects{\n    width: auto;\n    margin-right: 0px;\n\n    box-shadow: 0px 0px 5px rgba(34,34,34,0.6);\n\n    display: grid;\n    grid-template-columns: 1fr;\n    grid-template-rows: 50px 1fr;\n    justify-content: center;\n}\n\n#projectheader{\n    display: flex;\n    align-items: center;\n\n    padding-left: 20px;\n\n    box-shadow: 0px 1px 1px black;\n}\n\n#projectlist > div{\n    display: flex;\n    align-items: center;\n\n    padding-left: 20px;\n}\n\n#addproject{\n    margin-left: auto;\n    margin-right: 20px;\n}\n\n#projectlist > button{\n    background-color: transparent;\n    border: none;\n\n    text-align: left;\n    padding-left: 20px;\n\n    transition: box-shadow .15s ease-in-out;\n}\n\n#projectlist > button:hover{\n    box-shadow: 0px 0px 5px rgba(34,34,34,0.6);\n\n    transition: box-shadow .15s ease-in;\n}\n\n#projectlist{\n    display: grid;\n\n    grid-template-columns: 1fr;\n    grid-auto-rows: 50px;\n}`, \"\"]);\n// Exports\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);\n\n\n//# sourceURL=webpack:///./src/styles/projects.css?./node_modules/css-loader/dist/cjs.js");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _scripts_logger__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./scripts/logger */ \"./src/scripts/logger.js\");\n/* harmony import */ var _scripts_ClassManager__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./scripts/ClassManager */ \"./src/scripts/ClassManager.js\");\n/* harmony import */ var _scripts_DisplayController__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./scripts/DisplayController */ \"./src/scripts/DisplayController.js\");\n/* harmony import */ var _styles_main_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./styles/main.css */ \"./src/styles/main.css\");\n\n\n\n\n\nconst projectManager = (function(){\n    let projectList = [];\n\n    const Init = function(){\n        const savedProjects = JSON.parse(localStorage.getItem(\"projects\") || \"[]\");\n\n        if(savedProjects.length <= 0){\n            CreateProject(\"Default board\");\n            return;\n        }\n        \n        for(let i = 0; i < savedProjects.length; i++){\n            let projectData = savedProjects[i];\n            let savedProject = new _scripts_ClassManager__WEBPACK_IMPORTED_MODULE_1__.Project(projectData.name);\n            savedProject.SetDescription(projectData.description);\n            savedProject.SetPriority(projectData.priority);\n            (0,_scripts_logger__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(savedProject);\n\n            projectList.push(savedProject);\n        }\n\n        (0,_scripts_logger__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(savedProjects);\n    }\n\n    const SaveProjects = function(){\n        localStorage.setItem(\"projects\", JSON.stringify(projectList));\n    }\n\n    const CreateProject = function(projectName) {\n        const newProject = new _scripts_ClassManager__WEBPACK_IMPORTED_MODULE_1__.Project(projectName);\n        projectList.push(newProject);\n\n        (0,_scripts_logger__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(projectList);\n\n        (0,_scripts_logger__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(\"Created new project with name: \" + projectName);\n        SaveProjects();\n        return newProject;\n    }\n\n    const GetProjectList = () => projectList;\n\n    return{Init, CreateProject, GetProjectList};\n})();\n\nconst taskManager = (function(){\n\n    const CreateTask = function(project, taskName){\n        const newTask = new _scripts_ClassManager__WEBPACK_IMPORTED_MODULE_1__.Task(taskName);\n        project.AddTask(newTask);\n        newTask.SetPriority(_scripts_ClassManager__WEBPACK_IMPORTED_MODULE_1__.priority.low);\n        (0,_scripts_logger__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(\"Created new task with name: \" + taskName);\n        return newTask;\n    }\n\n    return{CreateTask};\n})();\n\nfunction InitializePage(){\n    projectManager.Init();\n\n    const project = projectManager.GetProjectList()[0];\n\n    _scripts_DisplayController__WEBPACK_IMPORTED_MODULE_2__.projectDisplayer.loadProjects(projectManager.GetProjectList());\n    _scripts_DisplayController__WEBPACK_IMPORTED_MODULE_2__.projectDisplayer.loadTasks(project);\n}\n\nfunction SetupForms(){\n    let addProjectForm = document.getElementById('projectform');\n    addProjectForm.addEventListener(\"submit\", (e) =>{\n        e.preventDefault();\n\n        let boardName = document.getElementById('bname').value;\n        if(boardName == \"\")\n            return;\n\n        projectManager.CreateProject(boardName);\n        _scripts_DisplayController__WEBPACK_IMPORTED_MODULE_2__.buttonEvents.hideAddProjectPanel();\n\n        _scripts_DisplayController__WEBPACK_IMPORTED_MODULE_2__.projectDisplayer.loadProjects(projectManager.GetProjectList());\n    });\n}\n\nInitializePage();\nSetupForms();\n\n\n//# sourceURL=webpack:///./src/index.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ LogMessage)\n/* harmony export */ });\nfunction LogMessage(message){\n    console.log(message);\n}\n\n//# sourceURL=webpack:///./src/scripts/logger.js?");
...
eval("module.exports = __webpack_require__.p + \"c44ebbcca611dbf75547.otf\";\n\n//# sourceURL=webpack:///./src/PrimeForm.otf?");
